...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  var { ensureValidVNode: ensureValidVNode2 } = ssrUtils;
  ...
  var {
    ...
    pushWarningContext: pushWarningContext2,
    popWarningContext: popWarningContext2
  } = ssrUtils;
  ...
  function renderComponentVNode(vnode, parentComponent = null, slotScopeId) {
    const instance = vnode.component = createComponentInstance2(
      vnode,
      parentComponent,
      null
    );
    if (true) pushWarningContext2(vnode);
    const res = setupComponent2(
      instance,
      true
      /* isSSR */
    );
    if (true) popWarningContext2();
  ...
  function renderComponentSubTree(instance, slotScopeId) {
    if (true) pushWarningContext2(instance.vnode);
    const comp = instance.type;
    const { getBuffer, push } = createBuffer();
    if (isFunction(comp)) {
